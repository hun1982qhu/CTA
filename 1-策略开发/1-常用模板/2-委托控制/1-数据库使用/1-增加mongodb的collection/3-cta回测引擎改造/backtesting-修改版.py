...
class BacktestingEngine:
    ...
    def set_parameters(
        ...
        self.collection_name = collection_name  # 新增
    ...
    def run_ga_optimization(self, optimization_setting: OptimizationSetting, population_size=100, ngen_size=30, output=True):
        ...
        ga_collection_name = self.collection_name  # 新增
...
def optimize(
    ...
    )  # 新增 collection_name=collection_name
