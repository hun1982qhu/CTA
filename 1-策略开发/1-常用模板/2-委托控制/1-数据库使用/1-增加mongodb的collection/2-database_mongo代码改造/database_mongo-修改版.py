...
from mongoengine.context_managers import switch_collection  # 新增
...
class MongoManager(BaseDatabaseManager):
    ...
    def load_bar_data(
        ...
        if collection_name is None:  # 新增
            ...
            with switch_collection(DbBarData, collection_name):  # 新增
                s = DbBarData.objects(
                    symbol=symbol,
                    exchange=exchange.value,
                    interval=interval.value,
